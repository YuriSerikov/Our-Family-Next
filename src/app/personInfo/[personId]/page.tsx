...
export default function PersonIdPage({params:{personId}}: Props) {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 5; i++) {
      ...
      getNextKin(fullname, nextKin[i], passRelative);
    }
  }, [cleanRelative, fullname, passRelative]);
    ...
    <>
      ...
      <div className={stl.rltcontent}>
        ...
        <div>
          <NearRelatives
            persons={spouse}
            kinToAdd={choosenPerson}
            personA={person}
            choosenPersonGender={choosenPersonGender}
            cbAfterChange={cbSpouse}
          >
            супруг(а)
          </NearRelatives>
          <NearRelatives
